            ...
            <Routes>
              ...
              <Route path="settings" element={<SettingsList />} /> */}
                            ...
                            <Route
                                ...
                                element={<FormSubmissionForm />}
                            />
                            <Route
                                path="form-submissions/edit/:id"
                                element={<FormSubmissionForm />}
                            />
                            ...
                            <Route
                                ...
                                element={<StoreLocationList />}
                            />
                            <Route
                                path="store-locations/new"
                                element={<StoreLocationForm />}
                            />
                            <Route
                    ...
                    <Route
                        ...
                        element={
                            <div className="bg-white rounded-lg shadow-md p-6">
                                ...
                                <p>
                                    Select an option from the sidebar to get
                                    started.
                                </p>
                            </div>
                        }
